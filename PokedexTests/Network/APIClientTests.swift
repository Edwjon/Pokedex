...
final class APIClientTests: XCTestCase {
    ...
    func test_request_successfulDecoding() async throws {
        ...
        let url = Endpoint.pokemonDetail(id: 1).urlRequest!.url!.absoluteString
        mockClient.responses[url] = try JSONEncoder().encode(expected)
    ...
    func test_requestRawData_success() async throws {
        ...
        let url = Endpoint.pokemonImage(id: 1).urlRequest!.url!.absoluteString
